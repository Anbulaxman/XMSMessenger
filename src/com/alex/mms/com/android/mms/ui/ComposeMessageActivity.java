...
import static com.alex.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_ABORT;
import static com.alex.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_COMPLETE;
import static com.alex.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_START;
import static com.alex.mms.com.android.mms.transaction.ProgressCallbackEntity.PROGRESS_STATUS_ACTION;
import static com.alex.mms.com.android.mms.ui.MessageListAdapter.COLUMN_ID;
import static com.alex.mms.com.android.mms.ui.MessageListAdapter.COLUMN_MSG_TYPE;
import static com.alex.mms.com.android.mms.ui.MessageListAdapter.PROJECTION;
...
import com.alex.mms.com.android.internal.telephony.TelephonyIntents;
import com.alex.mms.com.android.internal.telephony.TelephonyProperties;
...
import com.alex.mms.com.android.mms.SystemPropertiesProxy;
import com.alex.mms.com.android.mms.TempFileProvider;
import com.alex.mms.com.android.mms.data.Contact;
import com.alex.mms.com.android.mms.data.ContactList;
import com.alex.mms.com.android.mms.data.Conversation;
import com.alex.mms.com.android.mms.data.WorkingMessage;
import com.alex.mms.com.android.mms.data.Conversation.ConversationQueryHandler;
import com.alex.mms.com.android.mms.data.WorkingMessage.MessageStatusListener;
import com.alex.mms.com.android.mms.drm.DrmUtils;
import com.alex.mms.com.android.mms.model.SlideModel;
import com.alex.mms.com.android.mms.model.SlideshowModel;
import com.alex.mms.com.android.mms.transaction.MessagingNotification;
import com.alex.mms.com.android.mms.ui.MessageListView.OnSizeChangedListener;
import com.alex.mms.com.android.mms.ui.MessageUtils.ResizeImageResultCallback;
import com.alex.mms.com.android.mms.ui.RecipientsEditor.RecipientContextMenuInfo;
import com.alex.mms.com.android.mms.util.AddressUtils;
import com.alex.mms.com.android.mms.util.PhoneNumberFormatter;
import com.alex.mms.com.android.mms.util.SendingProgressTokenManager;
import com.alex.mms.com.android.mms.util.SmileyParser;
import com.alex.mms.com.google.android.mms.ContentType;
import com.alex.mms.com.google.android.mms.MmsException;
import com.alex.mms.com.google.android.mms.pdu.EncodedStringValue;
import com.alex.mms.com.google.android.mms.pdu.PduBody;
import com.alex.mms.com.google.android.mms.pdu.PduPart;
...
public class ComposeMessageActivity extends Activity
    ...
    private ImageButton mAttachementButton;
    ...
    private void updateCounter(CharSequence text, int start, int before, int count) {
        ...
        if (true) {
            ...
            String counterText = msgCount > 0 ? remainingInCurrentMessage + " / " + msgCount
                    : String.valueOf(remainingInCurrentMessage);
            Log.i("Arindam"," "+remainingInCurrentMessage);
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        if (isRecipientCallable()) {
            MenuItem item = menu.add(0, MENU_CALL_RECIPIENT, 0, R.string.menu_call)
                .setIcon(R.drawable.contact_icon_makecall)
        ...
        if (MmsConfig.getMmsEnabled()) {
            if (!isSubjectEditorVisible()) {
                menu.add(0, MENU_ADD_SUBJECT, 0, R.string.add_subject).setIcon(
                        R.drawable.ic_menu_edit).setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
            }
...
//                .setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);    // add to actionbar
        ...
        if (!mWorkingMessage.hasSlideshow()) {
            menu.add(0, MENU_INSERT_SMILEY, 0, R.string.menu_insert_smiley).setIcon(
                    R.drawable.ic_menu_emoticons).setShowAsAction(MenuItem.SHOW_AS_ACTION_NEVER);
        }
        ...
        if (mMsgListAdapter.getCount() > 0) {
            ...
            if ((null != cursor) && (cursor.getCount() > 0)) {
                menu.add(0, MENU_DELETE_THREAD, 0, R.string.delete_thread).setIcon(
                    R.drawable.header_button_icon_delete).setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);;
            }
        } else {
...
//        return true;
    ...
    private void initResourceRefs() {
        ...
        mAttachementButton = (ImageButton) findViewById(R.id.attachement_button);
        mSendButtonMms.setOnClickListener(this);
        mSendButtonSms.setOnClickListener(this);
        mAttachementButton.setOnClickListener(this);
        mSendButtonMms.setEnabled(true);
